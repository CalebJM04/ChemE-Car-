...
(library Library_1
	...
	(symbolDef "IRLZ44NPBF" (originalName "IRLZ44NPBF")
	...
	(compDef "IRLZ44NPBF" (originalName "IRLZ44NPBF") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IRLZ44NPBF"))
		...
		(attr "Mouser Part Number" "942-IRLZ44NPBF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Infineon-Technologies/IRLZ44NPBF?qs=9%252BKlkBgLFf15OZZk%252BD0ibg%3D%3D")
		(attr "Manufacturer_Name" "Infineon")
		(attr "Manufacturer_Part_Number" "IRLZ44NPBF")
		(attr "Description" "N-channel MOSFET,IRLZ44N 47A 55V")
		(attr "<Hyperlink>" "http://www.irf.com/product-info/datasheets/data/irlz44n.pdf")
		(attr "<Component Height>" "4.69")
		(attr "<STEP Filename>" "IRLZ44NPBF.stp")
